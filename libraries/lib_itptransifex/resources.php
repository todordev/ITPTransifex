...
class ItpTransifexResources implements Iterator, Countable, ArrayAccess {
    ...
    public function load($ids, $state = null) {
        ...
        if(!$ids) {
            throw new InvalidArgumentException(JText::_("LIB_ITPTRANSIFEX_ERROR_INVALID_RESOURCE_IDS"));
        }
    ...
    public function loadByProjectId($id, $state = null) {
        ...
        if(!$id) {
            throw new InvalidArgumentException(JText::_("LIB_ITPTRANSIFEX_ERROR_INVALID_PROJECT_ID"));
        }
    ...
    public function loadByPackageId($id, $state = null) {
        ...
        if(!$id) {
            throw new InvalidArgumentException(JText::_("LIB_ITPTRANSIFEX_ERROR_INVALID_PACKAGE_ID"));
        }
