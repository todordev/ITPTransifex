...
?>
<form action="<?php echo JRoute::_('index.php?option=com_itptransifex&view=projects'); ?>" method="post" name="adminForm" id="adminForm">
...
<div class="modal hide fade" id="js-cfp-modal">
    ...
    <div class="modal-body">
        ...
        <form action="<?php echo JRoute::_('index.php?option=com_itptransifex&task=package.downloadProject'); ?>" method="get" name="languageForm" id="languageForm">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo JHtml::_('select.genericlist', $this->languages, 'js-cfp-language'); ?>
                        </div>
                    </div>
    ...
    <div class="modal-footer">
        ...
        <a href="#" class="btn btn-primary" id="js-btn-cfp-submit"><?php echo JText::_("COM_ITPTRANSIFEX_SUBMIT");?></a>
        <a href="#" class="btn" id="js-btn-cfp-cancel"><?php echo JText::_("COM_ITPTRANSIFEX_CANCEL");?></a>
    </div>
</div>