...
<form action="<?php echo JRoute::_('index.php?option=com_itptransifex&view=packages'); ?>" method="post"
    ...
    <div id="j-main-container" class="span10">
        ...
        <div id="j-main-container">
            ...
            <div id="filter-bar" class="btn-toolbar">
                <div class="filter-search btn-group pull-left">
                    <label for="filter_search"
                           class="element-invisible"><?php echo JText::_('COM_ITPTRANSIFEX_SEARCH_IN_NAME'); ?></label>
                    <input type="text" name="filter_search" class="hasTooltip" id="filter_search"
                           placeholder="<?php echo JText::_('COM_ITPTRANSIFEX_SEARCH_IN_NAME'); ?>"
                           value="<?php echo $this->escape($this->state->get('filter.search')); ?>"
                           title="<?php echo JText::_('COM_ITPTRANSIFEX_SEARCH_IN_NAME_TOOLTIP'); ?>"/>
                </div>
                <div class="btn-group pull-left">
                    ...
                    <button class="btn hasTooltip" type="button" title="<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?>"
                            id="js-search-filter-clear"><i class="icon-remove"></i></button>
                </div>
            ...
            <table class="table table-striped" id="packagesList">
