 ...
 *
 */
class ItpTransifexInstallHelper
{
    ...
    public static function createFolder($imagesPath)
    {
        ...
        if (true !== JFolder::create($imagesPath)) {
            JLog::add(JText::sprintf("COM_ITPTRANSIFEX_ERROR_CANNOT_CREATE_FOLDER", $imagesPath));
        } else {
            ...
            if (true !== JFile::write($indexFile, $html)) {
                JLog::add(JText::sprintf("COM_ITPTRANSIFEX_ERROR_CANNOT_SAVE_FILE", $indexFile));
            }
